from core.modules.computing_node import ProcessingModule
from core.modules.transmission_node import OutputModule
...
def case_edge_computing():
    ...
    obc = ProcessingModule(speed=30.0, phi=0.9)
    ...
    edge_computer = ProcessingModule(speed=300.0, phi=0.4)
    ...
    ground_link = OutputModule(speed=10.0)
